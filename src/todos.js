...
const todoManager = () => {
    ...
    const displayEditTodoForm = (todo) => {
        ...
        document.getElementById(`${todo.title}`).outerHTML =`<nav>
                                                            ...
                                                            <textarea id="editTodoDescription" class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:border-gray-500">${todo.description}</textarea>
                                                            ...
                                                            <div>
                                                                <button value="${todo.title}" id="editTodoButton" class="flex-shrink-0 bg-green-500 hover:bg-green-700 border-green-500 hover:border-green-700 text-sm border-4 text-white py-1 px-2 rounded" type="button">save</button>
                                                            </div>
                                                            <div>
